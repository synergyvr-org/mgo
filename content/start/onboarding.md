...
This documents the onboarding steps for MGO 4.0 **RC3**, the current release. Check out the [full load order for RC3](/load-order/mgo-4-rc3/) on this very site if you want the whole scoop. (Still on RC2? Check out [Onboarding (4.0 RC2)](/start/onboarding-rc2/) instead, as setup is different in a few places.)
{{< /aside >}}
