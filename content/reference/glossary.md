...
| <span id="vrik">VRIK</span> | A mod that gives you a full, animated body in VR and drives gestures, body holsters, and much of MGO's VR interaction. It's also the source of a default [control scheme](/controls). See the [VRIK Player Avatar](/mod-highlights/vrik) page. |
