...
* **Shaders "compile" in seconds, and the game looks wrong.** The [first launch](/first-launch/compiling-shaders) should spend multiple minutes compiling shaders. If it blows through in moments and you load into a world of wrong-looking textures, don't marvel at your luck. Compilation didn't really happen, and a dirty install is the likely culprit.
